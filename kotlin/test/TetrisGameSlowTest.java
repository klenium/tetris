...
public class TetrisGameSlowTest {
    ...
    @Test public void checlBoardSize() {
        assertEquals(game.getGameBoard().getSize().getWidth(), 5);
        assertEquals(game.getGameBoard().getSize().getHeight(), 6);
    }
    ...
    @Test public void tetrominoLanded() {
        ...
        TestUtil.checkBoardState(game.getGameBoard(), new String[] {
            ".....",
            ".....",
            ".....",
            "...#.",
